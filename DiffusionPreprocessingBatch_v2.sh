...
for Subject in ${Subjlist} ; do
  ...
  RawDataDir="${StudyFolder}/sub-${SubjectID}/dwi" #Folder where unprocessed diffusion data are
  ...
  PosData="${RawDataDir}/sub-${SubjectID}_acq-dir98PA_run-02_dwi.nii.gz@${RawDataDir}/sub-${SubjectID}_acq-dir99PA_run-04_dwi.nii.gz"
  NegData="${RawDataDir}/sub-${SubjectID}_acq-dir98AP_run-01_dwi.nii.gz@${RawDataDir}/sub-${SubjectID}_acq-dir99AP_run-03_dwi.nii.gz"
  ...
  EchoSpacing=$(echo "$(jq -r '.EffectiveEchoSpacing' ${RawDataDir}/sub-${SubjectID}_acq-dir98AP_run-01_dwi.json)/.001" | bc -l)
